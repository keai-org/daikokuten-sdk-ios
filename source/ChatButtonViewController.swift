...
/// ViewController that only contains the WebView chat interface without floating button
public class ChatWebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        print("=====> CHAT WEB VIEW CONTROLLER - VIEW DID LOAD")
        setupWebView()
    ...
    private func setupWebView() {
        print("=====> SETTING UP WEBVIEW FOR CHAT WEB VIEW CONTROLLER")
    ...
    private func loadWebViewContent(token: String?) {
        ...
        print("ChatWebViewController: Loading HTML with userId: \(escapedUserId), clientId: \(escapedClientId), testMode: \(testModeStr), token: \(token ?? "nil")")
